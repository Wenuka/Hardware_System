                            ...
                            <div class="box-body" style="padding:4%;">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    ...
                                    <div style="text-align: center;">
                                        <button type="button" style="margin-bottom: 3%;background-color: maroon;color: white;" class="btn btn-default" data-todo='<?php  echo json_encode($rep) ?>' id='<?php echo $rep->repID; ?>' data-id='<?php echo $rep->repID; ?>'  data-toggle="modal" data-target="#repModal">More details</button>
                                    </div>
                                </div>
                            </div>
                        </div>
