            ...
            <div class ="col-lg-12 col-md-12 col-sm-12" id="contetn_lg" style="padding: 0;">
                <div id="about_web" class="box box-solid"
                    ...
                    <div class="box-header with-border" style="text-align: center;">
                        <h3 class="box-title"
                            style="text-align: center;color:dimgrey;padding-top:6px;font-weight: bold;font-size: 18px;">Order Placement and Location</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body" style="padding:0 4%;">
                        <div class="col-md-12">
                            Street, address, location Map Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal1" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            Fixing Area Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal2" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            Plumbing Map Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal3" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            Quotation Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal4" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            Items Used Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal5" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                        </div>
                        <div class="col-md-6">
                            <form method="post" action="<?php echo site_url(); ?>/AgentController/addNewWorkEnd">
                              <div class="form-group">
                                <label for="nextDate">Planned Filter Instalation Date:</label>
