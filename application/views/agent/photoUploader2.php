            ...
            <div class ="col-lg-12 col-md-12 col-sm-12" id="contetn_lg" style="padding: 0;">
                <div id="about_web" class="box box-solid"
                    ...
                    <div class="box-header with-border" style="text-align: center;">
                        <h3 class="box-title"
                            style="text-align: center;color:dimgrey;padding-top:6px;font-weight: bold;font-size: 18px;">Fixing and Invoicing</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body" style="padding:0 4%;">
                        <div class="col-md-12">
                            Plumbing Map Area Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal6" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            Water Filter Fixing Finish Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal7" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            Filling Water, No Leak and Warranty Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal8" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            Fixed Item List Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal9" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            500ml per time Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal10" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                            Warranty Card, Delivery Note and Agreement Photo: <br>
                            <button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal11" style="background-color: #8892d6;border: #8892d6;">Add New Images </button><br><br>
                        </div>
                        <div class="col-md-6">
