                        ...
                        <div class="box-body" style="padding:4%;">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div style="text-align: center;">
                                    <button type="button" style="margin-bottom: 3%;color: white;background-color: maroon;" class="btn btn-default" data-todo='<?php  echo json_encode($agent) ?>' id='<?php echo $agent->agentID; ?>' data-id='<?php echo $agent->agentID; ?>'  data-toggle="modal" data-target="#agentModal">More details</button>
                                </div>
                            </div>
                        </div>
                    </div>
