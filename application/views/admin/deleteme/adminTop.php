 ...
 <div class="row">
        ...
        <div class="col-lg-3 col-xs-6" >
          ...
          <div class="small-box " style="background-color: #45bbe0;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <a href="<?php echo base_url ('index.php/AdminController/viewFilter'); ?>" class="small-box-footer" style="padding:6px 0;"><i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
   ...
   <p style="margin:0;">Customer Count: </p>
            ...
            <a href="<?php echo base_url ('index.php/AdminController/viewCustomer'); ?>" class="small-box-footer" style="padding:6px 0;"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color:#78c350;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <div class="inner" style="color: white;">
              <h3 id="notifications"></h3>
               ...
               <p style="font-size:1.4em;margin:4px;"><?php echo $admindata->name; ?> </p>

            </div>
            <div class="icon">
              <i class="ion ion-pie-graph"></i>
            </div>
            <a href="<?php echo base_url ('index.php/AdminController/viewAdmin'); ?>" class="small-box-footer" style="padding:6px 0;"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      </div>
