                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                        <div id="about_web" class="box box-solid" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);border-top: 3px solid #d2d6de;">
                            <div class="box-header with-border" style="text-align: center;">
                                <h3 class="box-title"
                                    style="text-align: center;color:dimgrey;padding-top:6px;font-weight: bold;font-size: 18px;">Work ID #<?php echo $workID; ?></h3>
                            </div>
                            <div class="box-body" style="padding:0 4%;">
                                <div id="jssor_2" style="position:relative;margin:0;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
                                    <!-- Loading Screen -->
                                ...
                                <div class="row" style="padding: 5px; margin-bottom: 10px;">
                                    <div class="col-md-12">
                                        Agent ID: <?php echo $workdata->agent_id; ?><br>
                                        Plumber Name: <?php echo $workdata->plumbername; ?><br>
                                        Description: <?php echo $workdata->description; ?><br>
                                        Date Time: <?php echo $workdata->insert_time; ?><br> 
                                    </div>
                                    <div class="col-md-6">
                                        <br>
                                        <b>Codes:</b>
                                        <?php 
                                        for ($cd=0; $cd < sizeof($codes); $cd++) { 
                                            echo "<br>".$codes[$cd]->code."-".$codes[$cd]->description;
                                        }
                                        ?>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <b>Parts:</b>
                                        <?php 
                                        for ($pt=0; $pt < sizeof($parts); $pt++) { 
                                            echo "<br>".$parts[$pt]->part."-".$parts[$pt]->description;
                                        }
                                        ?>
                                    </div>
                                </div>
