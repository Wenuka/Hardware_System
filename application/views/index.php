...
<head>
  ...
  <title>Batapola Water Filter</title>
...
<div class="login-box" style="background: #8892d6;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
    <div class="login-logo" >
        <a href="" style="color:white;text-align: left;"><b>Batapola Group</b><br><span style="font-size:20px;">Water Filter Service Center</span></a>
  </div>
  <!-- /.login-logo -->
