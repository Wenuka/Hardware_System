                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                  <label for="fullname">Agent ID</label>
                                                  <input type="text" class="form-control is-disabled" value="<?php echo $agentdata->agent_id; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                  <label for="fullname">Name</label>
                                                  <input type="text" class="form-control is-disabled" value="<?php echo $agentdata->name; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                  <label for="fullname">Email</label>
                                                  <input type="text" class="form-control is-disabled" value="<?php echo $agentdata->email; ?>" disabled>
                                                </div>
                                                <div class="form-group">
                                                  <label for="fullname">Mobile</label>
                                                  <input type="text" class="form-control is-disabled" value="<?php echo $agentdata->mobile; ?>" disabled required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
