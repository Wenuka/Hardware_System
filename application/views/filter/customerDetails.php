                            ...
                            <div class="row">
                              ...
                              <form enctype="multipart/form-data" id="form1" method="POST">
                                <div class="col-md-3" style="padding-top: 5%; margin-top: 10px;padding-bottom: 5%;border: 2px solid #f4f4f4;">
                                  ...
                                  <div class="text-center">
                                    <?php 
                                    if ($customerdata->image_path != null){
                                      echo '<img src="../../'.$customerdata->image_path.'" width=200 height=200 class="avatar img-circle" alt="avatar">';
                                    }
                              ...
                              <script type="text/javascript">
                                ...
                                document.getElementById("uploadBtn").addEventListener('click', function(e){
                                  e.preventDefault();
                                  var imgCount = 0;
                                  var id = <?php echo $customerdata->customer_id; ?>;
                                  var type = 'customer';
                                ...
                                <div class="col-md-9">
                                  ...
                                  <form class="is-readonly" method="POST" action="<?php echo site_url(); ?>/FilterController/editMyAccount" id="form2" role="form" data-toggle="validator">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control is-disabled" id="fullname" name="fullname" placeholder="Full Name" value="<?php echo $customerdata->name; ?>" disabled required>
                                    </div>
                                    <div class="form-group">
                                      <label for="exampleInputEmail1">Email address</label>
                                      <input type="email" class="form-control is-disabled" id="email" name="email" placeholder="Email" value="<?php echo $customerdata->email; ?>"  data-error="Bruh, that email address is invalid" disabled required>
                                      <div class="help-block with-errors"></div>
                                    </div>
                                    <div class="form-group">
                                      <label for="tel">Mobile</label>
                                      <input type="tel" class="form-control" id="mobile" name="mobile" value="<?php echo $customerdata->mobile; ?>" data-maxlength="10" data-minlength="10" pattern="[0-9]{10}" disabled required/>
                                      <div class="help">Format of the telephone number should be [0711234567] (length - 10 numbers.)</div>
                                    </div>  
                                    <div class="form-group">
                                      <label for="tel">Land Line</label>
                                      <input type="tel" class="form-control is-disabled" id="tele" name="tele" value="<?php echo $customerdata->landline; ?>" maxlength="10" minlength="9" pattern="[0]{1}[0-9]{9}" disabled required>
                                      <div class="help">Format of the telephone number should be [0112501264] (length - 10 numbers.)</div>
                                    </div>
