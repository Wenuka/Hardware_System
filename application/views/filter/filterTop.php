<?php ?>
 ...
 <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box " style="background-color: #8892d6;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <div class="inner" style="color: white;">
              <h3 id="orders"></h3>
              <p style="margin:0;">Next Service:</p>
               <p style="font-size:1.2em;margin:0;"><?php echo $filterdata->next_service; ?></p>

            </div>
            <div class="icon">
              <i class="ion ion-bag"></i>
            </div>
            <a href="<?php echo base_url ('index.php/FilterController/viewFilter'); ?>" class="small-box-footer" style="padding:6px 0;"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6" >
          ...
          <div class="small-box " style="background-color: #45bbe0;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <div class="inner" style="color: white;">
              <h3 id="visitors"></h3>
               ...
               <p style="font-size:1.2em;margin:0;"><?php echo $customerdata->name; ?></p>
  </div>
            <div class="icon">
              <i class="ion ion-stats-bars"></i>
            </div>
            <a href="<?php echo base_url ('index.php/FilterController/viewCustomer'); ?>" class="small-box-footer" style="padding:6px 0;"><i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
   ...
   <p style="margin:0;">Agent: </p>
               <p style="font-size:1.2em;margin:0;"><?php echo $agentdata->name; ?></p>

            </div>
            <div class="icon">
              <i class="ion ion-person-add"></i>
            </div>
            <a href="<?php echo base_url ('index.php/FilterController/viewAgent'); ?>" class="small-box-footer" style="padding:6px 0;"> <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box" style="background-color:#78c350;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            <div class="inner" style="color: white;">
              <h3 id="notifications"></h3>
                ...
                <p style="margin:0;">Capacity:</p>
               <p style="font-size:1.2em;margin:0;"><?php echo $filterdata->capacity; ?> Liters</p>
