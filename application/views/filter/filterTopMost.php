            ...
            <li class="dropdown user user-menu" >
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="user-header" style="text-align: center;background-color: #222d32;">
                        <img src="<?php echo (isset($customerdata))?'../../'.$customerdata->image_path:'../../assets/images/customer/avatar.png';?>"  style='border-radius: 40%;' class="img-circle" alt="User Image">

                        <p>
                            <?php echo (isset($customerdata))?$customerdata->name:'';?>
                            <small>Customer ID #<?php echo (isset($customerdata))?$customerdata->customer_id:'';?></small>
                        </p>
                    </li>
                    <!-- Menu Body -->
